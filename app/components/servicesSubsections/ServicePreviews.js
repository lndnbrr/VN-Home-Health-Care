...
export default function ServicePreview() {
 return (
   <div className="flex flex-col md:flex-row gap-5 ml-5 mr-5">
    <Link href="/pages/skilledservices/skilledNursing" className="flex flex-col flex-1 border border-color-primary border-4 rounded-2xl p-6 text-primary transition-transform duration-200 ease-out hover:-translate-y-2 hover:shadow-lg hover:bg-hover-c focus-visible:-translate-y-2 focus-visible:shadow-lg focus-visible:bg-hover-c">
        ...
        <p className="italic mt-2">click to find out more</p>
      </Link>
      <Link href="/pages/skilledservices/rehabilitation" className="flex flex-col flex-1 border border-color-primary border-4 rounded-2xl p-6 text-primary transition-transform duration-200 ease-out hover:-translate-y-2 hover:shadow-lg hover:bg-hover-c focus-visible:-translate-y-2 focus-visible:shadow-lg focus-visible:bg-hover-c">
        <div className="flex justify-center">
      ...
      <Link href="/pages/skilledservices/homeHealthAide" className="flex flex-col flex-1 border border-color-primary border-4 rounded-2xl p-6 text-primary transition-transform duration-200 ease-out hover:-translate-y-2 hover:shadow-lg hover:bg-hover-c focus-visible:-translate-y-2 focus-visible:shadow-lg focus-visible:bg-hover-c">
        <div className="flex justify-center">
      ...
      <Link href="/pages/skilledservices/medicalSocialServices" className="flex flex-col flex-1 border border-color-primary border-4 rounded-2xl p-6 text-primary transition-transform duration-200 ease-out hover:-translate-y-2 hover:shadow-lg hover:bg-hover-c focus-visible:-translate-y-2 focus-visible:shadow-lg focus-visible:bg-hover-c">
        <div className="flex justify-center">
