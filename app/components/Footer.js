...
export default function Footer() {
  ...
  return (
    ...
    <footer className="pl-5 flex items-center justify-center bg-primary text-white">
      <div className="pr-4 flex flex-col justify-center text-[15px] md:text-[20px] lg:text-[25px]">
        <div className="transition-transform duration-200 ease-out hover:-translate-y-1 hover:text-hover-dark-c focus-visible:-translate-y-1 focus-visible:text-hover-dark-c py-1">
          <a href="tel:+12482543582">Work Phone: (248) 254-3582</a>
        </div>
        <div className="transition-transform duration-200 ease-out hover:-translate-y-1 hover:text-hover-dark-c focus-visible:-translate-y-1 focus-visible:text-hover-dark-c py-1">
          <a href="tel:+18339736953">Toll Free: (833) 973-6953</a>
        </div>
        <div className="hover:text-hover-dark-c focus-visible:-translate-y-1 focus-visible:text-hover-dark-c py-1">
      ...
      <div className="basis-1/2 sm:basis-1/3 lg:basis-1/3">
        <a href="https://www.mapquest.com/us/michigan/vidhya-d-jain-vn-home-health-care-inc-284939901">
          ...
          <p className="text-[#D9DDDC] text-[13px] lg:text-[17px] pb-5"><i>Office location is in the Kybya Building on Orchard Lake Rd between 13 Mile and 12 Mile Rd!</i></p>
        </a>
      </div>
    </footer>
    </>
